...
**Porto Release 3.2** is the current public release line. It was prepared on 2026-06-20 with release note: **Kent Reis @ Porto, Portugal**.

![KR Book To Audio — Porto Release 3.2](docs/images/kr_book_to_audio_porto_release_3_2_20260620.png)

Porto Release 3.2 is the text-processing stabilization release. It promotes the Prepare mode workflow to the public release line, adds a current target-runtime screenshot, keeps article-aware part splitting, retains pronunciation dictionary compatibility, and corrects the visible desktop title to KR Book To Audio 3.2.
...
- Release notes: `docs/RELEASE_NOTES_PORTO_RELEASE_3_2.md`
- Latest screenshot: `docs/images/kr_book_to_audio_porto_release_3_2_20260620.png`
...
Internal engineering checkpoints were used during development. They are not public product names. The public-facing version for the current release is **Porto Release 3.2**.
...
Porto Release 3.2 is a source-code and UI screenshot checkpoint. Windows portable packaging is an Owner-machine target-runtime artifact and should be attached only when generated and verified.
